...
window.I18N_COMMON.ru = {
  ...
  incomplete_body: 'На часть проверок ответа не пришло, поэтому оценка не угадывается, а не выставляется вовсе. Ниже перечислено, чего не хватает.',
...
window.I18N_COMMON.uk = {
  ...
  incomplete_body: 'На частину перевірок відповіді не надійшло, тому оцінку не вгадують, а не виставляють зовсім. Нижче перелічено, чого бракує.',
